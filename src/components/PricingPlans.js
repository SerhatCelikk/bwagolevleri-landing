...
const plans = [
  {
    ...
    color: "bg-lake-700",
    rows: [
      { type: "1+1", price: "3.450.000 ₺", down: "246.500 ₺", monthly: "246.500 ₺ × 13", extra: "13 ay" },
      { type: "2+1", price: "4.785.000 ₺", down: "342.000 ₺", monthly: "342.000 ₺ × 13", extra: "13 ay" },
      { type: "3+1", price: "5.900.000 ₺", down: "421.500 ₺", monthly: "421.500 ₺ × 13", extra: "13 ay" },
    ],
  ...
  },
  {
    ...
    color: "bg-gold-500",
    rows: [
      { type: "1+1", price: "3.450.000 ₺", down: "1.725.000 ₺", monthly: "1.725.000 ₺", extra: "Tapuda" },
      { type: "2+1", price: "4.784.000 ₺", down: "2.392.000 ₺", monthly: "2.392.000 ₺", extra: "Tapuda" },
      { type: "3+1", price: "5.900.000 ₺", down: "2.950.000 ₺", monthly: "2.950.000 ₺", extra: "Tapuda" },
    ],
  ...
  },
  {
    ...
    color: "bg-navy-700",
    rows: [
      { type: "1+1", price: "3.450.000 ₺", down: "—", monthly: "3.100.000 ₺", extra: "%10 indirim" },
      { type: "2+1", price: "4.785.000 ₺", down: "—", monthly: "4.300.000 ₺", extra: "%10 indirim" },
      { type: "3+1", price: "5.900.000 ₺", down: "—", monthly: "5.300.000 ₺", extra: "%10 indirim" },
    ],
